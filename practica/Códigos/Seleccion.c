...
//Septiembre 2022
//ESCOM-IPN
//Medicion de tiempo del algoritmo de ordenamiento por Seleccion
//Compilacion: "gcc Seleccion.c tiempo.c  -o ordenamientos"
...
int main(int argc, char const*argv[]){
	...
	printf("SELECCION con %d datos", n);
...
//Funcion del algoritmo de ordenamiento por seleccion
void Seleccion(int *A,int n){
	//******************************************************************	
	//						Variables del algoritmo
	//******************************************************************
	int i,k; //Variables para hacer las iteraciones necesarias
	int p;	//Variable para guardar el índice de un elemento del arreglo a mover
