...
//Septiembre 2022
//ESCOM-IPN
//Medicion de tiempo del algoritmo de ordenamiento por Burbuja Optimizada 1
//Compilacion: "gcc BurbujaOptimizada1.c tiempo.c  -o ordenamientos"
...
int main(int argc, char const*argv[]){
	...
	printf("BURBUJA OPTIMIZADA 1 con %d datos", n);
