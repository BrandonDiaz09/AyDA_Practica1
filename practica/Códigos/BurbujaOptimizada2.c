...
//Septiembre 2022
//ESCOM-IPN
//Medicion de tiempo del algoritmo de ordenamiento por Burbuja Optimizada 2
//Compilacion: "gcc BurbujaOptimizada2.c tiempo.c  -o ordenamientos"
...
int main(int argc, char const*argv[]){
	...
	printf("BURBUJA OPTIMIZADA 2 con %d datos", n);
...
//Funcion del algoritmo de ordenamiento por burbuja optimizada 2
void BurbujaOpt2(int *A,int n){
	//******************************************************************	
	//						Variables del algoritmo
	//******************************************************************
	int i=0,j; //Variables para hacer las iteraciones necesarias
	int aux; //Variable auxiliar para guardar temporalmente el contenido de un índice del arreglo
	int cambios=1; //Variable centinela que indica que se realizó un cambio
